...
class ImageToPDFConverter:
    ...
    def initialize_ui(self):
        ...
        convertButton = tk.Button(self.root,text="Convert to PDF",font=("Comic Sans MS",12,"bold"),fg="white",bg="#003b63",activebackground="#005999",activeforeground="white",padx=20,pady=8,command=self.convert_images_to_pdf)
        convertButton.pack(pady=(0,25))
    ...
    def convert_images_to_pdf(self):
        ...
        output_pdf_path = filedialog.asksaveasfile(title="Save PDF As",initialfile=defaultName + ".pdf",defaultextension=".pdf",filetypes=[("PDF files", "*.pdf")])
